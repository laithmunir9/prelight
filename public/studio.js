(function () {
  ...
  function render() {
    ...
    document.getElementById('main').innerHTML = `<div class="prelight-studio"><div class="pl-shell pl-simple ${f?'':'pl-first-use'}">
      ...
      `):`<div class="pl-empty"><h2>Record your first take</h2><p>Record yourself. See what happened. Try again. Compare.</p><button class="pl-btn pl-primary" id="firstTake">Record your first take</button></div>`}</section>
      </div>${modalHtml()}</div>`;
    bind();
  }
  function modalHtml() {

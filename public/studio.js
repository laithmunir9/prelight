(function () {
  ...
  const brand = '<a class="pl-brand" href="/" aria-label="Prelight home"><img src="/prelight-character.png" width="36" height="36" alt=""/>Prelight</a>';
  function save() {
  ...
  function render() {
    ...
    document.getElementById('main').innerHTML = `<div class="prelight-studio"><div class="pl-shell pl-simple ${f?'':'pl-first-use'}">
      ...
      `):`<div class="pl-empty"><img class="pl-character" src="/prelight-character.png" width="88" height="88" alt=""/><h2>Record your first take</h2><p>Record yourself. See what happened. Try again. Compare.</p><button class="pl-btn pl-primary" id="firstTake">Record your first take</button></div>`}</section>
      </div>${modalHtml()}</div>`;
    bind();
  }
  function modalHtml() {
